...
const ModalView = () => {
  return (
    <ModalWrapper>
      <div
        className="modal-main bg-primary absolute top-1/2 left-1/2 -translate-x-1/2  -translate-y-1/2 
      max-w-[800px] w-full rounded-md border border-line overflow-hidden"
      >
          ...
          <div className="grid grid-cols-[1fr,_250px] gap-5">
            <div>
              ...
              <p className="text-xs leading-relaxed">
                ...
                Praesentium sapiente commodi dolores quod nulla perferendis
                distinctio quidem magnam earum itaque.
              </p>
            </div>
            <div className="space-y-5">
              <p className="text-xs leading-relaxed">
                <span className="opacity-60">Cast: </span>Hinata Shoyo, Tobio
                Kageyama & Tsukishima more...
              </p>
              <p className="text-xs leading-relaxed">
                <span className="opacity-60 ">Genre: </span>Anime
              </p>
            </div>
          </div>
        </div>
